/*
 * The Studocyte mark in two registers:
 *   • playful — the shared circular Cyto model used throughout the product
...
export function StudocyteMark({
  ...
  return <Cyto mood="happy" size={size} title={title} className={className} />
}
