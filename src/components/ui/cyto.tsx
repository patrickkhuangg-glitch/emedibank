  ...
  return (
    <svg className={`cyto ${className}`} data-mood={mood} width={size} height={size} viewBox="-10 -14 120 132" {...a11y}>
      ...
      <g className="char">
        ...
        <g className="cyto-face">
        <g className="eyes">
          <g className="eye-open" data-show><ellipse cx="40" cy="48" rx="7.8" ry="10" fill="#fff" /><ellipse cx="60" cy="48" rx="7.8" ry="10" fill="#fff" /><circle className="cyto-pupil" cx="42" cy="50" r="4.5" fill="#17162c" /><circle className="cyto-pupil" cx="62" cy="50" r="4.5" fill="#17162c" /><circle className="cyto-highlight" cx="43.5" cy="47.5" r="1.6" fill="#fff" /><circle className="cyto-highlight" cx="63.5" cy="47.5" r="1.6" fill="#fff" /></g>
