...
export function InviteStudentForm() {
  ...
  return <form action={action} className="mt-6 space-y-4">
    <label className="block text-sm font-semibold text-white"><span>Student name</span><input name="fullName" autoComplete="name" placeholder="e.g. Jordan Smith" className="field-dark mt-2" /></label>
