  ...
  return <Container className="py-10 sm:py-14"><main className="mx-auto max-w-6xl">
    ...
    <section className="mt-8 grid gap-5 lg:grid-cols-[minmax(0,1fr)_22rem] lg:items-start">
      <div className="space-y-5">
        <AccountPanel title="Students" description="Student profiles, package access and account emails." count={students.length} empty="No student accounts yet.">
          {students.map((account) => <AccountRow key={account.user.id} account={account} student />)}
        </AccountPanel>
