...
export default async function Page({params}:{params:Promise<{attemptId:string}>}){
 ...
 <section><h2 className="font-display text-xl font-semibold">Original transcript</h2><p className="mt-3 whitespace-pre-wrap leading-7">{a.transcript??'No transcript available. You can review the recording and mark manually.'}</p></section>
