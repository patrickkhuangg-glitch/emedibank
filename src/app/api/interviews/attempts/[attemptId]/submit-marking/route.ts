...
export async function POST(request:Request,{params}:{params:Promise<{attemptId:string}>}) {
 ...
 if(attempt.format==='panel')throw new InterviewApiError('Panel interviews are marked as one full-panel submission for 12 credits. Open the full panel to submit.',409)
