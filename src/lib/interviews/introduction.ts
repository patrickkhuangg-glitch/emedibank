...
export const INTRO_STEPS=[
 ...
 {path:'/interviews/practice',target:'practice-preview',title:'Prepare, rehearse, then record',body:'Open the selected station for a preparation timer and an unrecorded rehearsal. When you want to watch yourself back, use Mock Interviews to record. Afterwards, save what you learnt in your dashboard Study notes.'},
