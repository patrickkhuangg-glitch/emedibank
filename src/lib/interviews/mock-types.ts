import type { RoleplayPart } from './roleplay'
...
export type MockOption = { id: string; format: InterviewFormat; label: string; category: string }
...
export type MockView = {
 ...
 responsePart?: { kind: RoleplayPart; questionIndex: number; questionCount: number };
