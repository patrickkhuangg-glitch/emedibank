...
test('side-by-side tour cards share the target vertical centre when the viewport has room',()=>{
 const p=positionTour({left:700,top:180,width:500,height:400},{width:1440,height:900},{width:390,height:300})
 assert.equal(p.side,'right')
 assert.equal(p.y,230)
})
