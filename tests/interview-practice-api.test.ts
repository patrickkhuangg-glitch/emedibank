...
const shared={'@/lib/interviews/trial':{requireInterviewPractice:async()=>({kind:'full'})},'@/lib/auth/dal':auth,'@/lib/supabase/admin':admin,'@/lib/interviews/api':api,'@/lib/interviews/stations':{INTERVIEW_STATIONS},'@/lib/interviews/timing':{getInterviewTiming},'@/lib/interviews/practice-progress':{practiceDay:()=> '2026-09-14'}}
