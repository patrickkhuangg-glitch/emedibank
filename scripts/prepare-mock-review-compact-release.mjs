...
const dir='artifacts/mock-review-compact-release';mkdirSync(dir,{recursive:true});
const paths=["src/components/mock-report/panels.tsx","src/components/mock-report/report.module.css","src/components/diagnostic/exam-introduction.tsx"];
