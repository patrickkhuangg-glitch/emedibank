...
const result = await vercel(`/v13/deployments?teamId=${team}`, {method:'POST', body:JSON.stringify({
  ...
  meta:{purpose:'Expanded-by-default trial comparisons, manual collapse and clear free versus paid inclusions across Interviews, UCAT, GAMSAT and ISAT', sourceDeployment:baseline.id},
})});
