...
const dir='artifacts/mock-postmortem-release';mkdirSync(dir,{recursive:true});
const paths=["src/lib/mock/report/types.ts","src/lib/mock/report/actions.ts","src/lib/mock/report/analyse.ts","src/lib/mock/report/postmortem.ts","src/components/mock-report/postmortem.tsx","src/components/mock-report/panels.tsx","src/components/mock-review.tsx"];
