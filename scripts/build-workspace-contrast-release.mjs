...
const destination = resolve('.vercel/workspace-contrast-release');
mkdirSync(destination, { recursive: true });
for (const entry of manifest) {
  let content;
  for (const candidate of [entry.file, `.vercel/workspace-entry-release/${entry.file}`, `.vercel/workspace-redesign-release/${entry.file}`]) {
