...
const paths = [
  ...readdirSync('src/components/workspace').map(name => `src/components/workspace/${name}`),
  'src/lib/workspace/routes.ts', 'src/lib/dashboard/activity.ts', 'src/lib/dashboard/milestones.ts', 'src/lib/dashboard/stats.ts',
  'src/app/(app)/layout.tsx', 'src/app/(app)/dashboard/page.tsx',
  'src/app/(app)/practice/[examSlug]/page.tsx', 'src/app/(app)/practice/[examSlug]/practice-tabs.tsx',
  'src/app/(app)/mock/[examSlug]/page.tsx',
  'src/components/exam-switcher.tsx', 'src/components/site-nav.tsx',
