...
const dir='artifacts/mock-report-release';mkdirSync(dir,{recursive:true});
const paths=['src/lib/mock/token.ts','src/lib/supabase/types.ts','src/components/mock-runner.tsx','src/components/diagnostic/runner.tsx','src/components/mock-review.tsx','src/components/mock-review-base.tsx','src/app/(app)/mock/[examSlug]/[mockId]/page.tsx','src/app/(app)/mock/[examSlug]/mini/[subtestSlug]/[mockId]/page.tsx'];
